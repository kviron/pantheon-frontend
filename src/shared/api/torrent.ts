...
const makeRequest = async (method: string, path: string, data?: any, isJson?: boolean): Promise<any> => {
...
export const TorrentApi: RqbitAPI & { getVersion: () => Promise<string> } = {
